...
PROGRAM_INFO("Decision Stump",
    "An implementation of a single-level decision tree (a decision stump). "
    "With labeled data, a decision stump can be trained and saved, and used to "
    "predict the classes of new points.",
