...
func TestRunBindingNoFlag(t *testing.T) {
  ...
  i := 12
  s := "hello"
  _, double_out, int_out, _, _, _, _, string_out, _, _, _ :=
...
func TestRunBindingWrongString(t *testing.T) {
  ...
  i := 12
  s := "goodbye"
  _, _, _, _, _, _, _, string_out, _, _, _ :=
      mlpack.Test_go_binding(d, i, s, param)
...
func TestRunBindingWrongDouble(t *testing.T) {
  ...
  i := 12
  s := "hello"
  _, double_out, _, _, _, _, _, _, _, _, _ :=
      mlpack.Test_go_binding(d, i, s, param)
...
func TestGonumMatrix(t *testing.T) {
  ...
  i := 12
  s := "hello"
  _, _, _, matrix_out, _, _, _, _, _, _, _ :=
      mlpack.Test_go_binding(d, i, s, param)
...
func TestGonumUMatrix(t *testing.T) {
  ...
  i := 12
  s := "hello"
  _, _, _, _, _, _, _, _, _, umatrix_out, _ :=
      mlpack.Test_go_binding(d, i, s, param)
...
func TestModelForceCopy(t *testing.T) {
  ...
  _, _, _, _, model_bw_out2, _, _, _, _, _, _ :=
